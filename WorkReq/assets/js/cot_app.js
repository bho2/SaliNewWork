var cot_app = function(sName) {
	...
	this.hasLeftNav=this.includeFormValidation=this.includePlaceholders=this.includeMultiSelect=this.includeOMS=this.includeFullCalendar=this.includeDatePicker=false;
